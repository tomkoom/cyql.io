...
interface RectBtnProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  btnType: "primary" | "secondary" | "accept" | "reject"
  text: string
  icon?: ReactNode
}

const RectBtn: FC<RectBtnProps> = ({ btnType, text, icon, ...props }): JSX.Element => {
  return (
    <RectBtnStyled btnType={btnType} {...props}>
...
const RectBtnStyled = styled.button<{ btnType: "primary" | "secondary" | "accept" | "reject" }>`
  height: 3rem;
  display: flex;
  align-items: center;
