import { ProjectLogo, UnifiedBreadcrumb } from "@/components"
    ...
    <header className="mb-4 flex flex-col gap-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2">
          {verifyAdmin(userId) && (
            <Button size="lg" variant="secondary" className="group flex h-13 w-13 items-center justify-center rounded-full" onClick={openEditModal}>
              <Icon lucideName="SquarePen" className="text-coolgray-400 transition-colors group-hover:text-white" />
            </Button>
          )}
