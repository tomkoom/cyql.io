...
import { idlFactory } from './cyql_frontend.did.js';
export { idlFactory } from './cyql_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CYQL_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cyql_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cyql_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cyql_frontend.did.js")._SERVICE>}
 */
export const cyql_frontend = createActor(canisterId);
