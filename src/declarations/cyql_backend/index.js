...
import { idlFactory } from './cyql_backend.did.js';
export { idlFactory } from './cyql_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CYQL_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cyql_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cyql_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cyql_backend.did.js")._SERVICE>}
 */
export const cyql_backend = createActor(canisterId);
