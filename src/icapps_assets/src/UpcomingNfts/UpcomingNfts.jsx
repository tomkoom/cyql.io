...
const iconArrowRight = <FontAwesomeIcon icon={faArrowRight} color="rgba(255,255,255,0.3)" />;
		...
		<section className={`${css.upcNft} container768`}>
			...
			<div className={`${css.upcNft__hero} center`}>
				...
				<p className="bodyText">
					...
					Please note: We do not guarantee information provided on this page is 100%
					accurate. Please do your own research.
				</p>
